...
import TextArea from '../../ui-component/CustomTextarea';
import { Formik, getIn } from 'formik';
import RichEditor from '../../ui-component/RichEditor';
...
export default function SendMail({ setModal, data, handleSubmit, loading }) {
  ...
  const initailData = {
    to: data !== [] && data.length > 0 ? data.map((val) => val.email).toString() : "",
    subject: "",
    msg: ""
  }
            ...
            {({ values, setFieldValue, handleSubmit, errors }) => (
              <>
                <Input
                  ...
                  errMsg={getIn(errors, "to") !== undefined ? getIn(errors, "to") : ""}
                ...
                <Input
                  ...
                  errMsg={getIn(errors, "subject") !== undefined ? getIn(errors, "subject") : ""}
